    ...
    <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-center sm:hidden gap-x-4">
                ...
                <button class=" material-symbols-outlined text-md text-white/[.8] ahover:text-white " href="#">
        ...
        <div id="navbar-collapse-with-animation"
            ...
            <div
                ...
                <button class=" material-symbols-outlined text-md text-white/[.8] ahover:text-white "
                    href="#">shopping_cart</button>
