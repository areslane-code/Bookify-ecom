<!-- ========== FOOTER ========== -->
<footer class="w-full mt-auto bg-blue-700">
        ...
        <div class="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div class="col-span-1">
                ...
                <div class="grid mt-3 space-y-3">
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">Pricing</a></p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">Changelog</a></p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">Docs</a></p>
                </div>
            </div>
            <!-- End Col -->
            ...
            <div class="col-span-1">
                ...
                <div class="grid mt-3 space-y-3">
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">About us</a></p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">Blog</a></p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">Careers</a> <span
                            class="inline px-2 py-1 text-xs text-white bg-blue-700 rounded-lg ms-1">We're hiring</span>
                    </p>
                    <p><a class="inline-flex text-gray-400 gap-x-2 hover:text-gray-200" href="#">Customers</a></p>
                </div>
            </div>
            <!-- End Col -->
