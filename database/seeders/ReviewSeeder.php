...
class ReviewSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $bookReviews = [
            ['user_id' => 2, 'book_id' => 1, 'content' => 'This book is amazing! Highly recommended.'],
            ...
            ['user_id' => 5, 'book_id' => 4, 'content' => 'Disappointing, not what I expected.'],
            ...
            ['user_id' => 5, 'book_id' => 5, 'content' => 'The characters felt so real, fantastic storytelling.'],
