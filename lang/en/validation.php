...
return [
    ...
    */
    ...
    | convention "attribut.règle" pour nommer les lignes. Cela nous permet de
    ...
    */
    ...
    | par quelque chose de plus lisible, comme "Adresse e-mail" au lieu de "email". Cela nous aide simplement à rendre notre message plus expressif.
    |
    */
